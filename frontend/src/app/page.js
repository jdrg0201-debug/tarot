...
export default function Home() {
  ...
  useEffect(() => {
    const timers = [
      ...
      setTimeout(() => { setStep(3); playSound('sparkle'); }, 11000),
    ];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white overflow-hidden relative px-6 bg-transparent">
